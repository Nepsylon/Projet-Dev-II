...
class Quiz:
    ...
    def question(self, question_number):  # fonction qui initialise la question
        requete_donnees()
        t = Label(fenetre, text="Question pour une champion",
                  width=85, bg="orange", fg="white", font=(25))
        t.place(x=0, y=0)
...
def start():  # Fonction qui lance les différentes fonctions principales
    bienvenue.destroy()
    boutonStart.destroy()
    requete_categ()
    requete_diff()
...
boutonStart = Button(fenetre, text="Commencer", command=start,
                     width=10, bg="orange", fg="white", font=(16))
